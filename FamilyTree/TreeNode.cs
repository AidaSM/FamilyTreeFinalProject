...
namespace FamilyTree
{
    public class TreeNode<T> where T : IDrawable
    {
        ...
        // Constructors
        public TreeNode(T new_data) : this(new_data, new Font("Arial", 12))
        {
            Data = new_data;
        }
        ...
        // Arrange the node and his children in the area
        // Set xmin to indicate the right edge of the subtree
        // Set ymin to indicate the bottom edge of the subtree
        public void Arrange(Graphics gr, ref float xmin, ref float ymin)
        {
            // Verify the size of the node
            SizeF my_size = Data.GetSize(gr, MyFont);

            // Recursively arrange the children to have space for the new node
            float x = xmin;
            ...
            foreach (TreeNode<T> child in Children)
            {
                ...
                // Space before the next sibling
                x += Hoffset;
            }

            // Remove the space after the last child
            ...
            // Increase xmin to allow room for the subtree before returning
            xmin += subtree_width;
        ...
        // Draw the subtree with root as this node with the given upper left corner
        ...
        // Return the TreeNode at this point (or null if there isn't one)
